            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ isset($coupon) ? $coupon->updateUrl : route("coupon.store") }}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-4">
                                    <label for="code">شناسه کد</label>
                                    <input type="text" value="{{ isset($coupon->code) ? $coupon->code : '' }}" required
                                           class="form-control" name="code" id="code" placeholder="">
                                </div>
                                <div class="form-group col-4">
